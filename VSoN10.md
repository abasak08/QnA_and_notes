...
* Mass of W boson is $~ 140$ GeV which tells that they will exsists for very short time, from uncertainity principle $\Delta E . \Delta t > \hbar /2 $.
* And time (t) is small hence, Range given by, $R~c\Delta t$ will be small.
...
* In 1973, NC Interactions were introduced. This is the experimental evidence of GWS model. NC interaction was discovered in **Gargamelle experiment** in CERN.
  ...
  * $\bar{\nu}_\mu N \rightarrow \bar{\nu}_\mu N$ : **No muon neutrino produced**
